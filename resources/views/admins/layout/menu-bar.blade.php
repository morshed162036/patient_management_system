                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="{{ asset("admin/app-assets/images/portrait/small/avatar-s-16.jpg") }}" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center py-0">
                                            <div class="media-left pr-0"><img class="mr-1" src="{{ asset("admin/app-assets/images/icon/sketch-mac-icon.png") }}" alt="avatar" height="39" width="39"></div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="{{ asset("admin/app-assets/images/portrait/small/avatar-s-4.jpg") }}" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ asset("admin/html/ltr/vertical-menu-boxicons-template/index.html") }}">
                        <div class="brand-logo"><img class="logo" src="{{ asset("admin/app-assets/images/logo/logo.png") }}" /></div>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                ...
                <li class=" nav-item"><a href="#"><i class="bx bx-building"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a href="{{ asset("admin/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-1-column.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="1 column">1 column</span></a>
                        </li>
                        <li><a href="{{ asset("admin/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-2-columns.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a href="{{ asset("admin/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-fixed-navbar.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a href="{{ asset("admin/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-fixed.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                        <li><a href="{{ asset("admin/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-static.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Static layout">Static layout</span></a>
                        </li>
                    </ul>
                </li>
