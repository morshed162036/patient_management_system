                                                ...
                                                <div class="col-md-10">
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Name" aria-describedby="basic-addon1" name="department_name">
                                                        </div>
                                                    </fieldset>
                                                    <fieldset class="mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" id="basicTextarea" rows="3" placeholder="Textarea" name="department_description"></textarea>
                                                        </div>
                                                    </fieldset>
                                                    <fieldset class="mt-2">
                                                        <h5>Status</h5>
