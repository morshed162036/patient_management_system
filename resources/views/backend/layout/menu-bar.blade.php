                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">{{ Auth::user()->name }}</span><span class="user-status text-muted">{{ Auth::user()->user_type }}</span></div><span><img class="round" src="{{ asset("backend/app-assets/images/portrait/small/avatar-s-11.jpg") }}" alt="avatar" height="40" width="40"></span>
                            </a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ asset("backend/html/ltr/vertical-menu-boxicons-template/index.html") }}">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                 <li class=" nav-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
                </li>
               {{-- <li class=" navigation-header"><span>Apps</span>
                ...
                <li class=" nav-item"><a href="#"><i class="bx bx-user-plus"></i><span class="menu-title" data-i18n="User">User</span><span><i class="bx bx-right-arrow-alt float-right ml-5"></i></span></a>
                    <ul class="menu-content border border-1">
                        <li><a href="{{ route('user.index') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Users</span></a>
                        </li>
                        <li><a href="{{ route('role.index') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="View">User Role</span></a>
                        </li>
                    </ul>
                 </li>
                 <li class=" nav-item"><a href="{{ route('department.index') }}"><i class="bx bx-globe"></i><span class="menu-title" data-i18n="Google Maps">Department</span></a>
                </li>
               {{-- <li class=" nav-item"><a href="#"><i class="bx bx-building"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a href="{{ asset("backend/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-1-column.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="1 column">1 column</span></a>
                        </li>
                        <li><a href="{{ asset("backend/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-2-columns.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a href="{{ asset("backend/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-fixed-navbar.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a href="{{ asset("backend/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-fixed.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                        <li><a href="{{ asset("backend/starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-static.html")}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Static layout">Static layout</span></a>
                        </li>
                    </ul>
                </li>
